...
export default function Age2({textBox, setTextBox}) {
        ...
        <div className="App" style={{display: 'flex', flexDirection: "column"}}>
            <div style={{display: 'flex', flexDirection: 'row'}}>
                <div className="Interactive Field">
                    <InteractiveElement img={plant} posX={60} posY={10} text="plant" sound={plant_sound}/>
                    <InteractiveElement img={car} posX={40} posY={20} text="car" sound={car_sound}/>
                    <InteractiveElement img={astronaut} posX={30} posY={60} text="astronaught" sound={astronaut_sound}/>
                    <InteractiveElement img={skyscraper} posX={50} posY={55} text="skyscraper" sound={skyscraper_sound}/>
                    <InteractiveElement img={waterfall} posX={20} posY={10} text="waterfall" sound={waterfall_sound}/>
